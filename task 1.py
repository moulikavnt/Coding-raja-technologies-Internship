...
if __name__ == "__main__":   
    ...
    task_listbox = Listbox(functions_frame, width=70, height=9, font=("Arial", "10"), selectmode='SINGLE', background="WHITE", foreground="BLACK", selectbackground="#FF8C00", selectforeground="BLACK")    
